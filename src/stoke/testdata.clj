...
(def demand-future
  [{:Start 388, :Duration 49, :SRC :MeatEaters, :Quantity 31, :Priority
    0, :Component :Lifers}
   {:Start 3569, :Duration 174, :SRC :ButterChurners, :Quantity 67, :Priority
    0, :Component :WeekendWarriors}
   {:Start 3656, :Duration 49, :SRC :MeatEaters, :Quantity 94, :Priority 0,
    :Component :Lifers}
   {:Start 1885, :Duration 149, :SRC :MeatEaters, :Quantity 6, :Priority
    0, :Component :Lifers}
   {:Start 526, :Duration 16, :SRC :ButterChurners, :Quantity 98, :Priority
    1, :Component :WeekendWarriors}
   {:Start 1996, :Duration 24, :SRC :ButterChurners, :Quantity 89, :Priority
    0, :Component :WeekendWarriors}
   {:Start 2572, :Duration 154, :SRC :MeatEaters, :Quantity 47, :Priority 1,
    :Component :Lifers}
   {:Start 30, :Duration 49, :SRC :MeatEaters, :Quantity 34, :Priority  1,
    :Component :Lifers}
   {:Start 1891, :Duration 70, :SRC :MeatEaters, :Quantity 6, :Priority 0,
    :Component :Lifers}
   {:Start 3030, :Duration 172, :SRC :MeatEaters, :Quantity 95, :Priority 1,
    :Component :Lifers}])
